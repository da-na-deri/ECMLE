...
# Mixture components (4 components on square vertices)
K <- 4
radius <- 18      
...
alpha_weights <- c(0.25, 0.25, 0.25, 0.25)
...
# load("gmm4_2d_multiple_Yn20.RData")
# load("gmm4_2d_multiple_Yn50.RData")
load("gmm4_2d_multiple_Yn100.RData")
...
M <- gmm_2d_samples$M
K <- gmm_2d_samples$K
mu_matrix <- do.call(rbind, gmm_2d_samples$mu_components)
alpha_weights <- gmm_2d_samples$alpha_weights
sigma_scalar <- gmm_2d_samples$Sigma[1, 1]
...
# save(gmm_2d_multiple_Y_results, file = "gmm42_2d_multiple_Y_n20.RData")
# save(gmm_2d_multiple_Y_results, file = "gmm42_2d_multiple_Y_n50.RData")
save(gmm_2d_multiple_Y_results, file = "gmm42_2d_multiple_Y_n100.RData")